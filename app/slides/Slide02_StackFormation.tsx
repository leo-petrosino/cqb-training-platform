    ...
    <div className="h-full flex flex-col space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs font-mono">
        {[
          ...
          { role: '2ND MAN', color: 'text-military-300', desc: 'Opposite corner, covers point's blindside' },
