    ...
    <div className="h-full flex flex-col space-y-5">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="relative w-full max-w-2xl h-72">
          ...
          <div className={`absolute left-1/2 -translate-x-1/2 transition-all duration-1000 ${step >= 3 ? 'top-16 opacity-100' : 'top-32 opacity-0'}`}>
            ...
            <p className="text-accent-green text-xs font-mono mt-2 text-center">FLOW THROUGH — DO NOT STOP</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          ...
          { title: 'CLEAR FORWARD', desc: 'Do not look back. The rear guard has your six.' },
        ].map((tip, i) => (
